...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link collapsed" href="/vehicule/liste">
                    <i class="bi bi-grid"></i>
                    <span>Vehicule</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="/echeance/situation_type?user=1">
                    <i class="bi bi-grid"></i>
                    <span>Situation echeance</span>
                </a>
            </li>
             <li class="nav-item">
                <a class="nav-link collapsed" href="/vehicule/disponible?user=1">
