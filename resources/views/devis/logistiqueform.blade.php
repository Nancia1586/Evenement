    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="modal fade" id="addService" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="/devis/addlogistique" method="get" class="row g-3">
                            <div>
                                <center>
                                    <select style="width: 400px;" name="type" class="form-control">
                                        <?php foreach($logistique as $key){ ?>
            ...
            <div class="card">
                ...
                <br/>
                <div class="card-body" style="width: 1300px;">
                    <a href="/devis/diversform"><button type="button" class="btn btn-success">Valider</button></a>
                </div>
            </div>
        </div>
    </div>
